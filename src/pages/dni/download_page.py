import asyncio
import os
# from src.utils.load_yaml import DNI_QUOTATION_DIR
...
#                 category_c_available = True
        ...
        # dni_logger.debug("Proceed Button Clicked")
        ...
        try:
            ...
            dni_logger.error(f"Proceed button click failed: {e}")
        ...
        dni_logger.debug("Proceed to Submission Button Clicked")

        # await asyncio.sleep(10)
        # await screenshot_and_compare(self.page, "dni", "DNI_3")
...
#         dni_logger.debug("OK Button Clicked")
        ...
        #     dni_logger.info(f"Quotation No: {quotation_no} send to refferal")
        ...
        #             await self.page.reload()
        #             await self.page.wait_for_load_state('networkidle')
        #             dni_logger.debug("Page Reloaded for Quotation Status Check")
        #             await asyncio.sleep(1)
        ...
        #                 dni_logger.error(f"Quotation No: {quotation_no} is REJECTED By RAK please check data...")
        ...
        #     dni_logger.debug("Quotation No Clicked")
