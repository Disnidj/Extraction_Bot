...
class Category1Page:
    ...
    async def fill_category_1(self, catA, df2):
        ...
        try:
            ...
            await screenshot_and_compare(self.page, "orient", "ORIENT_2")
        except Exception as e:
            orient_logger.error(f"An error occurred while taking screenshot: {e}")
        ...
        await self._select_option('//*[@id="collapse_0"]/div/div/div[3]/div[11]/div[2]/div/dx-select-box/div/div/div[1]/input',  catA['Dental CO'].iloc[0], "Dental CO", df2)
        ...
        await self._select_option('//*[@id="collapse_0"]/div/div/div[3]/div[12]/div[2]/div/dx-select-box/div/div/div[1]/input', catA['Optical CO'].iloc[0], "Optical CO", df2)
        ...
        orient_logger.debug("Category A Completed")
