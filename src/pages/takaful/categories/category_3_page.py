...
class Category3Page:
    ...
    async def fill_category_3(self, catC):
        takaful_logger.debug("Category C Started")
        print('Cat C')
        ...
        if catC['TPA'].iloc[0] == 'Aafiya':
            fields = [
                ...
                {"name": "Geographical Area of Cover", "value": str(catC['Territory'].iloc[0]), "column": column},
                {"name": "Room Category", "value": str(catC['Room Category'].iloc[0]), "column": column},
                ...
                {"name": "OP Services - Lab, Radiology, etc", "value": str(catC['Op Co Insurance'].iloc[0]), "column": column},
                {"name": "Physiotherapy treatment, subject to prior approval", "value": str(catC['Physio'].iloc[0]), "column": column},
                ...
                {"name": "Maternity OP Services", "value": str(catC['Maternity - Married Females CO'].iloc[0]), "column": column},
                ...
                {"name": "Alternative Medicine", "value": str(catC['Alternative Medicine'].iloc[0]), "column": column},
                ...
                {"name": "Air Ticket (Referral from Insurance Company)", "value": str(catC['Airfare for IP Treatment'].iloc[0]), "column": column},
                {"name": "Shingrix Vaccine", "value": str(catC['Shiqinx Vaccine'].iloc[0]), "column": column}, 
        ...
        takaful_logger.debug("Category C Completed")
