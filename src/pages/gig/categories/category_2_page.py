...
class Category2Page:
    ...
    async def fill_category_2(self, cat2):
        ...
        try:
            ...
            await screenshot_and_compare(self.page, "gig", "GIG_4")  # Updated screenshot name for Category B
        ...
        #Coinsurance option
        coinsurance=str(cat2['Op Co Insurance'].iloc[0])
