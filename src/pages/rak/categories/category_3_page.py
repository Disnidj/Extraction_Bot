...
class Category3Page:
    ...
    async def fill_category_3(self, catC, df2):
        rak_logger.debug("Category C Started")
        print('Cat C')
        # Convert all DataFrame values to strings
        catC = catC.astype(str)

        await asyncio.sleep(10)
        await screenshot_and_compare(self.page, "rak", "RAK_2_CAT3")

        # # General Benefits
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[1]/div[2]/div/div[2]/dx-select-box/div/div/div[1]/input', catC['Network'].iloc[0].split('-')[0].strip(), "Network Part 1", df2)
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[1]/div[1]/div/dx-select-box/div/div/div[1]/input',(network_value := catC['Network'].iloc[0].split('- ', 1)[1].strip()) + (" " if network_value in ["Green","Silver Premium"] else ""),"Network Part 2", df2)

        # # Other Fields
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[1]/div[2]/div/dx-select-box/div[1]/div/div[1]/input', catC['Territory'].iloc[0], "Territory", df2)
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[2]/div[1]/div/dx-select-box/div/div/div[1]/input',catC['Annual Limit'].iloc[0], "Annual Limit", df2)
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[2]/div[2]/div/dx-select-box/div[1]/div/div[1]/input',catC['Reimbursement'].iloc[0].replace('100%', '100 %') if catC['Reimbursement'].iloc[0] == '100% of UCR' else catC['Reimbursement'].iloc[0],"Reimbursement", df2)
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[4]/div[1]/div/dx-select-box/div[1]/div/div[1]/input', "Up to AAL", "Consultation Limit", df2)
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[4]/div[2]/div/dx-select-box/div/div/div[1]/input', catC['Deductable'].iloc[0], "Deductable", df2)
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[5]/div[1]/div/dx-select-box/div[1]/div/div[1]/input', "Up to AAL", "Co-payment on diagnostics", df2)
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[5]/div[2]/div/dx-select-box/div/div/div[1]/input',  catC['Diagnostic Copay'].iloc[0], "Diagnostic Copay", df2)
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[6]/div[1]/div/dx-select-box/div/div/div[1]/input', catC['Limit of Phamacy'].iloc[0], "Limit of Phamacy", df2)
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[6]/div[2]/div/dx-select-box/div/div/div[1]/input', catC['Pharmacy'].iloc[0], "Pharmacy", df2)
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[7]/div/div/dx-select-box/div/div/div[1]/input', catC['Physio Co'].iloc[0], "Physio Co", df2)
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[9]/div[1]/div/dx-select-box/div/div/div[1]/input', catC['Maternity - Married Females'].iloc[0], "Maternity - Married Females", df2)
        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[9]/div[2]/div/dx-select-box/div/div/div[1]/input', "NIL", "Waiting Period", df2)

        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[11]/div[1]/div/dx-select-box/div/div/div[1]/input', catC['Dental'].iloc[0], "Dental", df2)
        # if catC['Dental'].iloc[0] != 'Not Covered':
        #     await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[11]/div[2]/div/dx-select-box/div[1]/div/div[1]/input',  catC['Dental CO'].iloc[0], "Dental CO", df2)

        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[13]/div[1]/div/dx-select-box/div/div/div[1]/input', catC['Optical'].iloc[0], "Optical", df2)
        # if catC['Optical'].iloc[0] != 'Not Covered':
        #     await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[13]/div[2]/div/dx-select-box/div/div/div[1]/input', catC['Optical CO'].iloc[0], "Optical CO", df2)

        # await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[15]/div[1]/div/dx-select-box/div/div/div[1]/input', catC['Alternative Medicine'].iloc[0], "Alternative Medicine", df2)
        # if catC['Alternative Medicine'].iloc[0] != 'Not Covered':
        #     await self._select_option('//*[@id="collapse_2"]/div/div/div[2]/div[15]/div[2]/div/dx-select-box/div/div/div[1]/input', catC['Alternative Medicine Co'].iloc[0], "Alternative Medicine Co", df2)

        # rak_logger.debug("Category C Completed")
