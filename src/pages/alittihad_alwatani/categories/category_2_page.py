...
class Category2Page:
    ...
    async def fill_category_2(self, catB, region, tpa, network):
        alittihad_logger.debug("Category B Started")
        print('Cat B')
        ...
        if catB['TPA'].iloc[0] == ' Mednet':
            fields = [
                ...
                {"name": "Hospitalization and Day Treatment", "value": str(catB['Hospital accommodation Room'].iloc[0]), "column": column},#
                {"name": "OP Consultation", "value": str(catB['Consultation Limit'].iloc[0]), "column": column},
                ...
                {"name": "Second Medical Opinion", "value": str(catB['Second Medical Opinion'].iloc[0]), "column": column}, #
                {"name": "Maternity OP Services", "value":str(catB['Maternity Outpatient limit'].iloc[0]), "column": column},#
                {"name": "Maternity IP Services", "value": str(catB['Maternity In-patient Sublimit'].iloc[0]), "column": column},
                ...
                {"name": "Dialysis", "value": str(catB['Renal Dialysis'].iloc[0]), "column": column}, #            
                ...
                {"name": "Medical Appliances", "value": str(catB['Medical Appliances Sublimit'].iloc[0]), "column": column},
            ]
        ...
        alittihad_logger.debug("Category B Completed")
